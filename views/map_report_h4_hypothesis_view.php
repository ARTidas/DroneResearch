<?php
	 ...
	 * ********************************************************
	 * ********************************************************/
	class MapReportH4HypothesisView extends ProjectAbstractView {
        ...
        public function displayContent() {
			?>
                ...
                <script type="text/javascript" src="<?php print(RequestHelper::$url_root); ?>/js/map_report_h4_hypothesis.js"></script>
                ...
                <h1>
                    H4 hypothesis: "There is a correlation between noise pollution and utility of a drone."
                </h1>
                <h2>
                    "SO_Attitude" value vs. "W1" value
                </h2>
                ...
                <div id="stats_dashboard" style="
                    ...
                    <h3>H4 hypothesis statistical analysis</h3>
