<?php
	 ...
	 * ********************************************************
	 * ********************************************************/
	class MapReportH3HypothesisView extends ProjectAbstractView {
        ...
        public function displayContent() {
			?>
                ...
                <script type="text/javascript" src="<?php print(RequestHelper::$url_root); ?>/js/map_report_h3_hypothesis.js"></script>
                ...
                <h1>
                    H3 hypothesis: "Urban society views the presence of drones more positively."
                </h1>
                <h2>
                    "WT_Attitude" value vs. "Settlement type" group
                </h2>
                ...
                <div id="stats_dashboard" style="
                    ...
                    <h3>H3 hypothesis statistical analysis</h3>
